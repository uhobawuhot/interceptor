...
* Call set_defaults with the minimal of the following kwargs:
  ...
  Example:
    ...
    session.set_defaults(
        sql_connection="sqlite:///var/lib/interceptor/sqlite.db",
        sqlite_db="/var/lib/interceptor/sqlite.db")
...
from interceptor.openstack.common.db import exception
from interceptor.openstack.common.gettextutils import _  # noqa
from interceptor.openstack.common import log as logging
from interceptor.openstack.common import timeutils

sqlite_db_opts = [
    cfg.StrOpt('sqlite_db',
               default='interceptor.sqlite',
    ...
    def _do_query(self, q):
        ...
        for filename, line, method, function in traceback.extract_stack():
            ...
            if filename.endswith('db/api.py'):
                continue
            # only trace inside interceptor
            index = filename.rfind('interceptor')
            if index == -1:
                continue
