...
from interceptor.openstack.common import local
...
The current message format (version 2.0) is very simple.  It is:
    ...
    {
        'interceptor.version': <RPC Envelope Version as a String>,
        'interceptor.message': <Application Message Payload, JSON encoded>
    }
...
_VERSION_KEY = 'interceptor.version'
_MESSAGE_KEY = 'interceptor.message'
